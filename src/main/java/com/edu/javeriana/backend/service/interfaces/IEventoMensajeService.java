...
public interface IEventoMensajeService {
    ...
    List<EventoMensaje> buscarCatchesActivosPorNombreYCorrelationYEmpresa(String nombre, String correlation,
            Long empresaId);

    List<EventoMensaje> buscarCatchesActivosPorNombreYEmpresa(String nombre, Long empresaId);
}
